    ...
    <div className="max-w-4xl mx-auto space-y-8">      {/* Breadcrumb */}
      ...
      <div className="bg-white rounded-2xl shadow-lg border-2 border-gray-300 overflow-hidden">
        <div className="p-8 md:p-12">
          ...
          <div className="flex flex-col lg:flex-row lg:items-start justify-between gap-6 mb-8">
            <div className="flex-1">
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>                  <h1 className="text-4xl font-bold text-gray-900 mb-2">{selectedBook.titulo}</h1>
                  <div className="flex items-center gap-2 text-gray-800">
                    <span className="text-lg">✍️</span>
                    <p className="text-xl font-bold">{selectedBook.autor}</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="bg-gray-100 rounded-xl p-6 mb-8 border-2 border-gray-300">
            <h3 className="text-lg font-bold text-gray-900 mb-4">📋 Informações do Livro</h3>
            <div className="grid md:grid-cols-2 gap-4">
              <div>
                <span className="text-sm text-gray-800 font-semibold">ID do Livro</span>
                <p className="font-mono text-sm bg-white px-3 py-2 rounded border font-semibold">{selectedBook.id}</p>
              </div>
              <div>
                <span className="text-sm text-gray-800 font-semibold">Status Atual</span>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            >
              ...
              href="/books"
              className="px-6 py-4 border-2 border-gray-400 text-gray-900 font-bold rounded-xl hover:bg-gray-100 transition-colors flex items-center justify-center gap-2"
            >
          ...
          {/* Availability Info */}
          {selectedBook.status === 'disponível' && (            <div className="mt-6 bg-green-100 border-2 border-green-300 rounded-xl p-4">
              <div className="flex items-center gap-3">
                <span className="text-2xl">✅</span>
                <div>
                  <h3 className="font-bold text-green-800">Livro Disponível</h3>
          ...
          {selectedBook.status !== 'disponível' && (            <div className="mt-6 bg-yellow-100 border-2 border-yellow-300 rounded-xl p-4">
              <div className="flex items-center gap-3">
                <span className="text-2xl">ℹ️</span>
                <div>
                  <h3 className="font-bold text-yellow-800">Livro Indisponível</h3>
